...
import static com.chetakcargo.imageupload.utils.GlobalConstant.Url.BASE_URL;
...
public class ApiClient {
    ...
    private static void initOkHttp(@SuppressWarnings("unused") final Context context) {
